...
public class JDBC_Demo {
   ...
   public static void main (String [] args) {
      ...
      try { 
         ...
         String dbUrl = "jdbc:mysql://mysql.cs.iastate.edu:3306/db30916";
         String user = "adm309";
         String password = "EXbDqudt4";
          ...
          * Select *
          * From Food
          * Where Food.Type = "Fruit" AND Food.Name = "Apple"
          */
         ...
         ResultSet rs1 = stmt1.executeQuery ("select * from Persons"); 
         //int rs1 = stmt1.executeUpdate ("CREATE TABLE Persons(PersonID int,LastName varchar(255),FirstName varchar(255),Address varchar(255),City varchar(255));");
